...
export default async function ExpensesPage() {
  ...
  return (
    <div className="md:px-8 xl:p-12 space-y-6">
      <Toaster />
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div className="flex items-center gap-2 text-2xl md:text-3xl font-bold tracking-tight">
          <div className="relative bg-emerald-100/90 rounded-sm shadow-lg shadow-emerald-500/70 dark:shadow-emerald-700 p-1">
            <Receipt className="h-9 w-9 text-emerald-600 dark:text-emerald-400" />
          </div>

          <span>
            <h1>Manage Expenses</h1>
            <p className="text-[16px] font-light text-muted-foreground">
              Track, categorize, and control all operational costs
            </p>
          </span>
        </div>
            ...
            <TableRow>
              ...
              <TableHead>
                <div className="flex items-center gap-2">
                  <Calendar className="w-4 drop-shadow-sm dark:drop-shadow-md drop-shadow-black/80 text-emerald-500 fill-emerald-100" />
                  Date
                </div>
              </TableHead>
              <TableHead>
                <div className="flex items-center gap-2">
                  <Layers2 className="w-4 drop-shadow-sm dark:drop-shadow-md drop-shadow-black/80 text-yellow-500 fill-yellow-100" />
                  Category
                </div>
              </TableHead>
              <TableHead>
                <div className="flex items-center gap-2">
                  <File className="w-4 drop-shadow-sm dark:drop-shadow-md drop-shadow-black/80 text-blue-500 fill-blue-100" />{" "}
                  Description
                </div>
              </TableHead>
              <TableHead className="text-right">
                <div className="flex items-center gap-2 justify-end">
                  <Receipt className="w-4 drop-shadow-sm dark:drop-shadow-md drop-shadow-black/80 text-red-500 fill-red-100" />
                  Amount
                </div>
              </TableHead>
            </TableRow>
