    ...
    <div className="md:px-8 xl:p-12 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div className="flex items-center gap-2 text-2xl md:text-3xl font-bold tracking-tight">
          <div className="relative bg-violet-100/90 rounded-sm shadow-lg shadow-violet-500/70 dark:shadow-violet-700 p-1">
            <Truck className="h-9 w-9 text-violet-600 dark:text-violet-400" />
          </div>

          <span>
            <h1>Manage Vendors</h1>
            <p className="text-[16px] font-light text-muted-foreground">
              Organize service providers and track vendor relationships
            </p>
          </span>
        </div>
        ...
        <Table>
          <TableHeader className="bg-gray-100 dark:bg-gray-800">
            <TableRow>
              ...
              <TableHead>
                <div className="flex items-center gap-1">
                  <PhoneForwarded className="w-4 drop-shadow-sm dark:shadow-md fill-indigo-100 text-indigo-400 drop-shadow-black" />{" "}
                  Phone
                </div>
              </TableHead>
              <TableHead>
