  ...
  return (
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          <h2 className="text-4xl orboto md:text-5xl font-extrabold bg-gradient-to-r from-primary to-purple-500 bg-clip-text text-transparent tracking-tight">
            {t('whyChooseUsTitle')}
          </h2>
          ...
          {features.map((feature, idx) => (
            ...
            >
              ...
              <div className="relative mb-6 h-44 w-50 -mt-4">
                <Lottie animationData={feature.animationData} loop className="h-full w-full" />
              </div>
