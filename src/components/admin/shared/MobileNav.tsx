...
export default function MobileNav() {
  ...
  return (
    <>
      <div className="">
        <header className="fixed top-4 right-12 rounded-full backdrop-blur-2xl px-1.5 shadow-md  bg-background/60 drop-shadow-sm drop-shadow-black/20  dark:drop-shadow-white/50  z-50  transition-all duration-300 ease-in-out justify-between p-1 gap-2 p  hidden lg:flex">
          <AdminCommandMenu />
          <ThemeSwitcher />
          <NotificationBell />
      ...
      {open && (
        <>
          ...
          />
          {/* Drawer */}
          <aside className="fixed top-0 left-0 h-full w-72 bg-gradient-to-b from-background/95 to-background/80 backdrop-blur-xl shadow-xl z-50 transform transition-transform duration-300 ease-out">
