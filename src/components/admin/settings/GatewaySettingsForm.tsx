...
> = {
  SELCOM: {
    color:
      "dark:from-purple-500 dark:to-pink-500 from-purple-500/30 to-pink-500/20",
    icon: <Zap className="w-6 h-6 text-white" />,
    logo: (
      <Image
        src="/logos/selcom.png"
        width={16}
        height={16}
        alt="Selcom"
  ...
  FLUTTERWAVE: {
    color:
      "from-indigo-500/30 to-blue-500/30 dark:from-indigo-500 dark:to-indigo-600",
    ...
    logo: (
      <Image
        ...
        height={16}
        alt="Stripe"
        className="w-12 h-12 rounded-full border-2 border-white shadow-md z-90"
      />
    ),
  },
  PAYCHANGU: {
    color:
      "dark:from-yellow-400 dark:to-yellow-600 from-yellow-400/30 to-yellow-600/30",
...
export default function GatewaySettingsForm({
  ...
  return (
    <Card className="relative overflow-hidden rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 border-0">
      {/* Gradient background */}
      <div
        className={`absolute inset-0 bg-gradient-to-r ${style.color} opacity-20 blur-2xl`}
      />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Enter Selcom Vendor ID"
                        {...field}
                        className="border-indigo-300 focus:border-indigo-500 focus:ring-indigo-200"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
